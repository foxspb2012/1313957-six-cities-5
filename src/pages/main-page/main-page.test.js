...
describe(`Should MainPage render correctly`, () => {
  it(`Should MainPage render correctly with offers`, () => {
    const mockStore = configureStore();
    const store = mockStore(mockStateWithOffers);
    const tree = renderer
      .create(
  ...
  it(`Should MainPage render correctly without offers`, () => {
    const mockStore = configureStore();
    const store = mockStore(mockStateWithoutOffers);
    const tree = renderer
      .create(
          <Provider store={store}>
            <Router history={history}>
